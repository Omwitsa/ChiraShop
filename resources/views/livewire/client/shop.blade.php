                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                @foreach ($category->products as $p_index => $product)
                                    <div class="col-xs-12 col-sm-3 p-4 product-section">
                                        <a wire:click="viewInfo({{ $product->id }})" wire:key="{{ $product->id }}">
                                            <img src="{{ asset('storage'.env('IMG_STORAGE').$product->picUrl) }}" alt="Beauty">
                                        </a><br>
